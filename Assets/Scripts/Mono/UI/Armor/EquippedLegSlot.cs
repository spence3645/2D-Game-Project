...
public class EquippedLegSlot : EquippedArmorSlot, IDropHandler, IDragHandler, IEndDragHandler
{
    public override void EquipArmorPiece(PointerEventData eventData, string armorType)
    {
        if(armorType == "Legs")
        {
            ...
            equippedScript.EquipLegs(equippedArmor);
        }
    }
    ...
    public override void SwapArmorPiece(PointerEventData eventData, string armorType)
    {
        ...
        equippedScript.SwapArmor(equippedArmor, equippedArmorInfo, "Legs");
    }
}
