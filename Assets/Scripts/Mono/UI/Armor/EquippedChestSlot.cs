...
public class EquippedChestSlot : EquippedArmorSlot, IDropHandler, IDragHandler, IEndDragHandler
{
    public override void EquipArmorPiece(PointerEventData eventData, string armorType)
    {
        if(armorType == "Chest")
        {
            ...
            equippedScript.EquipChest(equippedArmor);
        }
    }
    ...
    public override void SwapArmorPiece(PointerEventData eventData, string armorType)
    {
        ...
        equippedScript.SwapArmor(equippedArmor, equippedArmorInfo, "Chest");
    }
}
