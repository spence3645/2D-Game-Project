...
public class DropBarrett : MonoBehaviour
{
    public GameObject base_barrett;
    ...
    {
        droppedWeapon = Instantiate(base_barrett, this.transform.position, Quaternion.identity, null);
